    ...
    <div className="mb-12 mt-28">
      ...
      <div className=" font-medium mt-7 flex  justify-center items-center gap-8">
        <div className="flex flex-col  justify-center items-center">
          <div className=" flex  justify-center items-center w-[270px] h-[270px] bg-purple-100 rounded-lg">
            <img src={Topc1}></img>
          </div>
          <div className="mt-2">
            <p>Cat Toys</p>
        ...
        <div className="flex flex-col  justify-center items-center">
          <div className="flex  justify-center items-center w-[270px] h-[270px] bg-rose-100 rounded-lg">
            <img src={Topc2}></img>
          </div>
          <div className="mt-2">
            <p>Cat Food</p>
        ...
        <div className="flex flex-col  justify-center items-center">
          <div className="flex  justify-center items-center w-[270px] h-[270px] bg-green-100 rounded-lg">
            <img src={Topc3}></img>
          </div>
          <div className="mt-2">
            <p>Dog Toys</p>
        ...
        <div className="flex flex-col  justify-center items-center">
          <div className="flex  justify-center items-center w-[270px] h-[270px] bg-yellow-100 rounded-lg">
            <img src={Topc4}></img>
          </div>
          <div className="mt-2">
            <p>Dog Food</p>
